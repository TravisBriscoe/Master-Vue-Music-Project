...
export default {
  ...
  data() {
    return {
      ...
      login_alert_message: 'Please wait! Loggin you in...',
    };
  },
  methods: {
    async login(value) {
      ...
      this.login_show_variant = 'bg-blue-500';
      this.login_alert_message = 'Please wait! Loggin you in...';
      ...
      this.login_alert_message = 'Success! You\'re now logged in.';
